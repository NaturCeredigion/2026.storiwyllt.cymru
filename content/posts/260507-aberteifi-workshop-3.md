...
Prior to the workshop Pip selected and printed A3 photos of different birds who live and forage in oak trees.
{{< gallery >}}
  {{< figure src="" caption="" >}}
  {{< figure src="" caption="" >}}
  {{< figure src="" caption="" >}}
...
The students drew lots last week to find out which bird they would be focusing on in their final artwork. 
{{< gallery >}}
  {{< figure src="" caption="" >}}
  {{< figure src="" caption="" >}}
  {{< figure src="" caption="" >}}
...
The students used the graphite transfer technique to make a drawing from the photo of their bird last week. 
{{< gallery >}}
  {{< figure src="" caption="" >}}
  {{< figure src="" caption="" >}}
  {{< figure src="" caption="" >}}
...
Today they placed the acetate over the drawing and used a black permanent marker to copy it directly on to the acetate to make a second layer..
{{< gallery >}}
  {{< figure src="" caption="" >}}
  {{< figure src="" caption="" >}}
  {{< figure src="" caption="" >}}
...
The students were introduced to collage art ,and spent the last hour choosing coloured sugar paper to collage their bird.
{{< gallery >}}
  {{< figure src="" caption="" >}}
  {{< figure src="" caption="" >}}
  {{< figure src="" caption="" >}}
...
This was done directly onto their original drawing, and the students chose to work with scissors or ripping the paper to the size they wanted to infill the bird drawing.
{{< gallery >}}
  {{< figure src="" caption="" >}}
  {{< figure src="" caption="" >}}
  {{< figure src="" caption="" >}}
